...
void initButtons() {
    ...
    //Initialization for BB1
    initButton(GPIO_PORT_P5, GPIO_PIN1); //BB1

     // enable the port 4 interrupt related to BB1
     Interrupt_enableInterrupt(INT_PORT5);

     // This allows us to start from a clean slate
     BB1modified = false;

     //Initialization for BB2
     initButton(GPIO_PORT_P3, GPIO_PIN5); //BB2

      // enable the port 4 interrupt related to BB2
      Interrupt_enableInterrupt(INT_PORT3);

      // This allows us to start from a clean slate
      BB2modified = false;

      //Initialization for LB1
      initButton(GPIO_PORT_P1, GPIO_PIN1); //LB1

       // enable the port 4 interrupt related to LB1
       Interrupt_enableInterrupt(INT_PORT1);

       // This allows us to start from a clean slate
       LB1modified = false;

       //Initialization for LB2
       initButton(GPIO_PORT_P1, GPIO_PIN4); //LB2

        // enable the port 4 interrupt related to LB2
        Interrupt_enableInterrupt(INT_PORT4);
